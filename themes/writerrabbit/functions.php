...
// Custom Post Types
add_action( 'init', 'create_quick_posts' );
function create_quick_posts() {
  $labels = array(
    'name' => _x('Quick Posts', 'post type general name'),
    'singular_name' => _x('QuickPosts', 'post type singular name'),
    'add_new' => _x('Add New', 'Quick Post'),
    'add_new_item' => __('Add New Quick Post'),
    'edit_item' => __('Edit Quick Post'),
    'new_item' => __('New Quick Post'),
    'view_item' => __('View Quick Post'),
    'search_items' => __('Search Quick Posts'),
    'not_found' =>  __('No Quick Posts found'),
    'not_found_in_trash' => __('No Quick Posts found in Trash'),
    'parent_item_colon' => ''
  );

  $supports = array('title', 'editor', 'revisions');

  register_post_type( 'quickpost',
    array(
      'labels' => $labels,
      'public' => true,
      'supports' => $supports
...
add_action( 'init', 'create_prompts' );
function create_prompts() {
  $labels = array(
    'name' => _x('Prompts', 'post type general name'),
    'singular_name' => _x('Prompts', 'post type singular name'),
    ...
    'not_found' =>  __('No Prompts found'),
    'not_found_in_trash' => __('No Prompts found in Trash'),
    'parent_item_colon' => ''
  );
